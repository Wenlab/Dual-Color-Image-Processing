...
%% Run.
    for ii = start_frame:step_size:end_frame
        ...
        [Affine_T,red_demons] = imregdemons(red_crop_image,refer_image,[500 400 200],'PyramidLevels',3,'AccumulatedFieldSmoothing',2.5,'DisplayWaitbar',false);
        green_demons = imwarp(green_crop_image,Affine_T,'linear');
