...
for i=start_frame:end_frame
    filename_in = [pre_name,num2str(i),input_extend];
    load(fullfile(file_path,filename_in),value_name);
    Y_shift = bsxfun(@minus,double(eval(value_name)),Y_mean);
